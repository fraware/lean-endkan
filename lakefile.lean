...
lean_lib Scratch where
  roots := #[`Scratch.SliceIsoMin, `Scratch.MathlibEndBetaExamples, `Scratch.MathlibEndBifunctorConsumer,
    `Scratch.MathlibCoendBetaExamples, `Scratch.MathlibFubiniExamples, `Scratch.MathlibKanBcExamples]
